...
class SalesBox extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Image.network(
          commonModel.icon,
          fit: BoxFit.fill,
          // MediaQuery.of(context).size.width 获取手机屏幕的高度　−５　是减padding
  ...
  Widget _doubleItem(BuildContext context, CommonModel leftModel,
    ...
    return Row(
      ...
      children: <Widget>[
        _item(context, leftModel, big, true, true),
        _item(context, rightModel, big, false, true),
      ],
    );
  }
}
